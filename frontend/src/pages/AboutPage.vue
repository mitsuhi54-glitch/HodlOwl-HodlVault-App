  ...
  <main class="about-container">
      ...
      <div class="user-flow">
        ...
        <div class="flow-step">
          ...
          <div>
            ...
            <p>When current price &ge; target, the "spend" path of the contract unlocks. The UI status shifts to "Ready to Withdraw."</p>
          </div>
        </div>
        <div class="flow-step">
    ...
    <section id="stack" class="about-section">
      ...
      <table class="table-stack">
        ...
        <tbody>
          <tr><td>Frontend</td><td>Vue 3, Quasar, Vite, Axios</td></tr>
