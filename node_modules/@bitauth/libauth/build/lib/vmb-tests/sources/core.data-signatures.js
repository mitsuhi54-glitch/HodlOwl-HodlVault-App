...
const byteLengthTestValues = byteLengths.map((i) => [`${i}`, `${i}`]);
export default [
    [
        'Data signatures',
        [
            ...setExpectedResults(generateTestCases(['<key1.ecdsa_data_signature.additional_script$0>', `<0> <$0> OP_NUM2BIN <key1.public_key> $1`, '$1 for $0 byte message'], [byteLengthTestValues, dataSigOps], {
                additionalScripts: {
...
//# sourceMappingURL=core.data-signatures.js.map