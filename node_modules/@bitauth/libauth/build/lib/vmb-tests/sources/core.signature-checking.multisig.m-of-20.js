...
export default [
    [
        'Signature checking',
        [
            ...setExpectedResults(generateTestCases([
            ...
            ...setExpectedResults(generateTestCases(['<$0> <$2.$1_signature.all_outputs> <key3.$1_signature.all_outputs>', '<2> <$3> OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP OP_DUP <key2.public_key> OP_OVER OP_DUP OP_DUP OP_DUP <key3.public_key> <20> OP_CHECKMULTISIG', '2-of-20 $1 multisig with $0, signatures $2 and 20, and $3'], [
                [
                    ['checkBits of zero', '0'],
...
//# sourceMappingURL=core.signature-checking.multisig.m-of-20.js.map