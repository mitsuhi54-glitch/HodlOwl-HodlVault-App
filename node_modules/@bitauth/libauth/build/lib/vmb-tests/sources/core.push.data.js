...
const twoByteLengths = [
    ['1 (2-byte)', '0x0100'],
    ['256', '0x0001'],
    ['65535', '0xffff'],
];
const fourByteLengths = [
    ['1 (4-byte)', '0x01000000'],
    ['65536', '0x00000100'],
    ['99990', '0x96860100'],
];
export default [
    [
        ...
        [
            ...
            ...setExpectedResults(generateTestCases(['$0', '$1', '$0 of $1 split across unlocking and locking bytecode'], [
                [
            ...
            ...setExpectedResults(generateTestCases(['$0 $1', '', '$0 of $1'], [
                [
                    ['OP_PUSHDATA_1', 'OP_PUSHDATA_1'],
                    ['OP_PUSHDATA_2', 'OP_PUSHDATA_2'],
                    ['OP_PUSHDATA_4', 'OP_PUSHDATA_4'],
            ...
            ...setExpectedResults(generateTestCases(['', '$0 $1', '$0 of $1 produces expected stack item'], [
                [
                    ['OP_PUSHDATA_1', 'OP_PUSHDATA_1'],
                    ['OP_PUSHDATA_2', 'OP_PUSHDATA_2'],
                    ['OP_PUSHDATA_4', 'OP_PUSHDATA_4'],
            ...
            ...setExpectedResults(generateTestCases(['<$1> OP_IF $0 OP_ENDIF', '', '<$1> OP_IF $0 OP_ENDIF in unlocking bytecode'], [
                [
            ...
            ...setExpectedResults(generateTestCases(['', '<$1> OP_IF $0 OP_ENDIF', '<$1> OP_IF $0 OP_ENDIF in locking bytecode'], [
                [
                    ['OP_PUSHDATA_1 ...', 'OP_PUSHDATA_1 76 $(<1> <76> OP_NUM2BIN) OP_SIZE <76> OP_EQUAL OP_NIP'],
                    ['OP_PUSHDATA_2 ...', 'OP_PUSHDATA_2 0x0001 $(<1> <256> OP_NUM2BIN) OP_SIZE <256> OP_EQUAL OP_NIP'],
                ],
...
//# sourceMappingURL=core.push.data.js.map