...
export default [
    [
        ...
        [
            ...
            ...setExpectedResults(generateTestCases(['<$1> OP_IF OP_$0 OP_ENDIF', '', '<$1> OP_IF OP_$0 OP_ENDIF in unlocking bytecode'], [
            ...
            ...setExpectedResults(generateTestCases(['', '<$1> OP_IF OP_$0 OP_ENDIF', '<$1> OP_IF OP_$0 OP_ENDIF in locking bytecode'], [
                range(16, 1).map((i) => [`${i}`, `${i}`]),
                [
                    ['0', '0'],
                    ['1', '1'],
...
//# sourceMappingURL=core.push.numbers.js.map