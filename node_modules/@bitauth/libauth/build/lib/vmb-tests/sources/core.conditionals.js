...
export default [
    [
        'Conditionals',
        [
            ...setExpectedResults(generateTestCases(['<$0>', 'OP_IF <$1> OP_ENDIF', '$0 OP_IF ($1)'], [
            ...
            ...setExpectedResults(generateTestCases(['<$0>', 'OP_NOTIF <$1> OP_ENDIF', '$0 OP_NOTIF ($1)'], [
                [...zerosAndOnes, ['<0xff>', '0xff'], ['<0xffff>', '0xffff'], ['520 bytes of 0xff', repeat('0xff', 520)], ['521 bytes of 0xff', repeat('0xff', 521)]],
                [
                    ['accept', '1'],
                    ['reject', '0'],
            ...
            ...setExpectedResults(generateTestCases(['<$0>', 'OP_IFDUP $1', '$0 OP_IFDUP $1'], [
                [...zerosAndOnes, ['<0xff>', '0xff'], ['<0xffff>', '0xffff'], ['520 bytes of 0xff', repeat('0xff', 520)], ['521 bytes of 0xff', repeat('0xff', 521)]],
                [
                    ['OP_NIP', 'OP_NIP'],
            ...
            ...setExpectedResults(generateTestCases(['<$0> $1', '<1>', '$0 $1 in unlocking bytecode (unbalanced)'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['<$0> $1', 'OP_ENDIF <1>', '$0 $1 in unlocking bytecode, OP_ENDIF locking bytecode'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['', '<$0> $1 <1>', '$0 $1 in locking bytecode (unbalanced)'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['<$0>', '$1 <1>', 'unlock: $0, lock: $1 (unbalanced)'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['', '<$0> $1 OP_ENDIF <1>', '$0 $1 OP_ENDIF in locking bytecode'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['<$0>', '$1 $2 OP_ENDIF', 'unlock: $0, lock: $1 $2 OP_ENDIF'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
            ...
            ...setExpectedResults(generateTestCases(['<1> <$0>', '$1 $2 OP_ENDIF', 'unlock: <1> $0, lock: $1 $2 OP_ENDIF'], [
                [
                    ['<1>', '1'],
                    ['<0>', '0'],
                ],
...
//# sourceMappingURL=core.conditionals.js.map