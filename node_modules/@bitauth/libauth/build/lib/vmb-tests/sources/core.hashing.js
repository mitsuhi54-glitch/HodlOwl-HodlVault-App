...
const byteLengths = [...range(56, 1), 64, 119, 120, 183, 184, 247, 248, 488, 503, 504, 520, 521, 1015, 1016].map((i) => [`${i}`, `${i}`]);
export default [
    [
        'Hashing operations',
        [
            ...setExpectedResults(generateTestCases(['<$(<0> <$1> OP_NUM2BIN $0)>', '<0> <$1> OP_NUM2BIN $0 OP_EQUAL', '$0 $1 bytes (0x00)'], [
                hashOps,
                [
                    ['0', '0'],
                    ['16', '16'],
...
//# sourceMappingURL=core.hashing.js.map