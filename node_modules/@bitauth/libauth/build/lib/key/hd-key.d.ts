...
export declare const hdKeyVersionIsPublicKey: (version: number) => version is HdKeyVersion.mainnetPublicKey | HdKeyVersion.testnetPublicKey;
export declare const hdKeyVersionIsPrivateKey: (version: number) => version is HdKeyVersion.mainnetPrivateKey | HdKeyVersion.testnetPrivateKey;
/**
...
export declare const encodeHdPrivateKey: <ThrowErrors extends boolean = true>(keyParameters: DecodedHdKey<HdPrivateNodeValid>, { crypto, throwErrors, }?: {
     ...
     */
    throwErrors?: ThrowErrors;
}) => ThrowErrors extends true ? HdPrivateKeyEncodeResult : HdPrivateKeyEncodeResult | string;
...
export declare const encodeHdPublicKey: <ThrowErrors extends boolean = true>(keyParameters: DecodedHdKey<HdPublicNodeValid>, { crypto, throwErrors, }?: {
     ...
     */
    throwErrors?: ThrowErrors;
}) => ThrowErrors extends true ? HdPublicKeyEncodeResult : HdPublicKeyEncodeResult | string;
/**
...
}) => PrivateNode extends HdPrivateNodeKnownParent ? HdPublicNodeKnownParent : HdPublicNodeValid;
/**
...
}) => ThrowErrors extends true ? HdPrivateNodeKnownParent : ReturnInvalidNodes extends false ? HdPrivateNodeKnownParent | string : HdPrivateNodeKnownParent<HdPrivateNode> | string;
/**
...
export declare const deriveHdPublicNodeChild: <ThrowErrors extends boolean = true, ReturnInvalidNodes extends boolean = false>(node: HdPublicNodeValid, index: number, { crypto, returnInvalidNodes, throwErrors, }?: {
     ...
     */
    throwErrors?: ThrowErrors;
}) => ThrowErrors extends true ? HdPublicNodeKnownParent : ReturnInvalidNodes extends false ? HdPublicNodeKnownParent | string : HdPublicNodeKnownParent<HdPublicNode> | string;
...
export declare const deriveHdPathRelative: <NodeType extends HdPrivateNodeValid | HdPublicNodeValid, Path extends string, ThrowErrors extends boolean = true>(node: NodeType, path: Path, { crypto, throwErrors, }?: {
     ...
     */
    throwErrors?: ThrowErrors;
}) => ThrowErrors extends true ? RelativeDerivation<NodeType, Path> : RelativeDerivation<NodeType, Path> | string;
...
export declare const deriveHdPath: <NodeType extends HdPrivateNodeValid | HdPublicNodeValid, Path extends string, ThrowErrors extends boolean = true>(node: NodeType, path: Path, { crypto, throwErrors, }?: {
     ...
     */
    throwErrors?: ThrowErrors;
}) => ThrowErrors extends true ? AbsoluteDerivation<NodeType, Path> : AbsoluteDerivation<NodeType, Path> | string;
