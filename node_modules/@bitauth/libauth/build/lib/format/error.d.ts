 ...
 */
export declare const assertSuccess: <T>(result: T | string, expectation?: string) => T;
export declare const assertNonNull: <T>(value: T | null | undefined, expectation?: string) => T & {};
