...
export declare const createOpActiveBytecode: ({ maximumStackItemLength, }?: {
    maximumStackItemLength?: number | undefined;
}) => <State extends AuthenticationProgramStateCodeSeparator & AuthenticationProgramStateError & AuthenticationProgramStateMinimum & AuthenticationProgramStateStack & AuthenticationProgramStateTransactionContext>(state: State) => State;
...
export declare const createOpUtxoBytecode: ({ maximumStackItemLength, }?: {
    maximumStackItemLength?: number | undefined;
}) => <State extends AuthenticationProgramStateError & AuthenticationProgramStateStack & AuthenticationProgramStateTransactionContext>(state: State) => State;
...
export declare const createOpInputBytecode: ({ maximumStackItemLength, }?: {
    maximumStackItemLength?: number | undefined;
}) => <State extends AuthenticationProgramStateError & AuthenticationProgramStateStack & AuthenticationProgramStateTransactionContext>(state: State) => State;
...
export declare const createOpOutputBytecode: ({ maximumStackItemLength, }?: {
    maximumStackItemLength?: number | undefined;
}) => <State extends AuthenticationProgramStateError & AuthenticationProgramStateStack & AuthenticationProgramStateTransactionContext>(state: State) => State;
