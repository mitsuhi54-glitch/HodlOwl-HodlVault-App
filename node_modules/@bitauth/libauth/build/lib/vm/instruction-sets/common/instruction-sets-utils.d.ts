import type { AuthenticationInstruction, AuthenticationInstructionMalformed, AuthenticationInstructionMaybeMalformed, AuthenticationInstructionPush, AuthenticationInstructions, AuthenticationInstructionsMalformed, AuthenticationInstructionsMaybeMalformed, Output, ReadPosition } from '../../../lib.js';
/**
 ...
 */
export declare const readLittleEndianNumber: (position: ReadPosition, length: typeof uint8Bytes | typeof uint16Bytes | typeof uint32Bytes) => number;
/**
 ...
 * @param position - the {@link ReadPosition} at which to start reading
 */
export declare const readAuthenticationInstruction: (position: ReadPosition) => {
...
export declare const isStandardnessPublicKeyEncodingPre2026: (publicKey: Uint8Array) => boolean;
 ...
 */
export declare const isStandardOutputBytecodePre2023: (lockingBytecode: Uint8Array) => boolean;
/**
 * Test that the provided locking bytecode matches one of the standard output
...
export declare const isStandardUtxoBytecode2023: (lockingBytecode: Uint8Array) => boolean;
/**
