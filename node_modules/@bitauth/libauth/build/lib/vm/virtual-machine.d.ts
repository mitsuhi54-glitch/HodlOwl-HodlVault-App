...
export type InstructionSet<ResolvedTransaction, AuthenticationProgram, ProgramState> = {
     ...
     */
    evaluate: (program: AuthenticationProgram, { stateEvaluate, stateInitialize, stateOverride, }: {
     ...
     */
    verify: (resolvedTransaction: ResolvedTransaction, { evaluate, success, initialize, }: {
        evaluate: (program: AuthenticationProgram, options?: {
            stateOverride?: Partial<ProgramState>;
        }) => ProgramState;
        success: (state: ProgramState) => string | true;
        initialize: (program: AuthenticationProgram) => Partial<ProgramState>;
...
export type MaskedProgramState<ProgramState extends AuthenticationProgramStateMinimum = AuthenticationProgramStateCommon> = Omit<ProgramState, 'instructions' | 'program'> & {
    /**
     ...
     * bytecode evaluation.
     */
    instruction: AuthenticationProgramStateMinimum['instructions'][number] | undefined;
};
/**
 * A set of pure-functions allowing transactions and their authentication
 * programs to be evaluated and inspected.
 */
export type AuthenticationVirtualMachine<ResolvedTransaction, AuthenticationProgram, ProgramState extends AuthenticationProgramStateMinimum> = {
    /**
     ...
     */
    debug: <MaskProgramState extends boolean = false>(program: AuthenticationProgram, options?: {
        /**
        ...
        stateOverride?: Partial<ProgramState>;
    }) => (MaskProgramState extends true ? MaskedProgramState<ProgramState> : ProgramState)[];
    /**
 ...
 */
export declare const partiallyCloneProgramState: <ProgramState extends AuthenticationProgramStateMinimum = AuthenticationProgramStateCommon>(state: ProgramState, referenceOnlyKeys?: string[], shallowCloneArrayKeys?: string[]) => ProgramState;
/**
 ...
 */
export declare const maskStaticProgramState: <ProgramState extends AuthenticationProgramStateMinimum = AuthenticationProgramStateCommon>(state: ProgramState) => MaskedProgramState<ProgramState>;
/**
